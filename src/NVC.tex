...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] Version Control}\\[2\baselineskip] % Title
{\large \textit{Git}}\\[4\baselineskip] % Tagline or further description
...
\title{{\zihao{1}Version Control Notes}}
